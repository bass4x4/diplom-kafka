...
public class GraphPanel extends JPanel {
    ...
    public GraphPanel(List<Double> scores, List<Double> amount) {
        this.scores = scores;
        this.amount = amount;
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < scores.size(); i++) {
            ...
            int y1 = (int) ((getMaxScore() - amount.get(i)) * yScale + padding);
        ...
        for (int i = 0; i < scores.size(); i++) {
            if (scores.size() > 1) {
                ...
                if ((i % ((int) ((scores.size() / 20.0)) + 1)) == 0) {
                    ...
                    g2.setColor(Color.BLACK);
                    String xLabel = scores.get(i).intValue() + "";
                    FontMetrics metrics = g2.getFontMetrics();
...
//    }
    ...
    private static void createAndShowGui() {
        ...
        for (int i = 0; i < maxDataPoints; i++) {
            ...
            amount.add(random.nextDouble() * maxScore);
        }
        GraphPanel mainPanel = new GraphPanel(scores, amount);
